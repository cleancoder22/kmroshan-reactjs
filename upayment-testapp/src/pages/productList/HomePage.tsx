...
type categoryType = {
  ...
  return (
    <>
           ...
           <div className="grid grid-cols-1 gap-y-10 sm:grid-cols-2 gap-x-6 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
              ...
              <> 
                <div className="mx-auto flex justify-center flex-col items-center">
                  <EmptyCart/>
                  <h2 className="font-bold ml-[7.5rem]">Oops! No items were found</h2>
                </div>
              </>
            )}
      ...
      <Link to="/create-product" className="w-[80px] h-[80px] flex justify-center items-center fixed bottom-6 bg-white right-12 rounded-full border border-[1px] border-black">
        <Plus/>
      </Link>
    </>
  );
